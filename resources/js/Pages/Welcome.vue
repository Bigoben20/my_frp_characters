        ...
        <div v-if="canLogin" class="p-6 sm:fixed sm:top-0 sm:right-0 text-end">
            ...
            <template v-else>
                ...
                <Link v-if="canRegister" :href="route('register')"
                    class="font-semibold text-gray-600 ms-4 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register
                </Link>
            </template>
        </div>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <div
                        ...
                        <div>
                            <div class="flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-800/20">
                                <img :src="ditto" alt="" class="w-10 h-10">
                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Karakterinizi Yaratın</h2>

                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Web sitemizde, kendinize özgü karakterler oluşturabilir ve düzenleyebilirsiniz. Adım adım karakterinizi yaratın, özelliklerini belirleyin ve hikayesini oluşturun. Dilerseniz daha sonra karakterinizde değişiklikler yapabilir veya detaylarını düzenleyebilirsiniz.
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-800/20">
                                <img :src="postIt" alt="" class="w-10 h-10">
                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Notlarınızı Saklayın</h2>

                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Sitemizde karakterlerinizle ilgili notlar alabilir ve saklayabilirsiniz. Karakterlerinizi geliştirmek veya hikayelerini detaylandırmak için not alma özelliği sayesinde fikirlerinizi not edebilirsiniz. Bu notlar istediğiniz zaman erişilebilir durumda olacak, böylece karakterlerinizin gelişimini takip etmek daha kolay olacak.
                            </p>
                        </div>
<!-- 
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="self-center w-6 h-6 mx-6 shrink-0 stroke-red-500">
                ...
                <div class="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-start">
                    <div class="flex items-center gap-4">
                        <a href="https://github.com/bigoben20"
                            class="inline-flex items-center gap-2 group hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
